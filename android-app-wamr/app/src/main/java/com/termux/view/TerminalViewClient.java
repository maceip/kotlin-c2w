 ...
 *
 * Vendored from Termux terminal-view v0.118.1. Modified to use WasmTerminalBridge instead of
 * TerminalSession.
 */
public interface TerminalViewClient {
    ...
    boolean onKeyDown(int keyCode, KeyEvent e, WasmTerminalBridge bridge);
    ...
    boolean onCodePoint(int codePoint, boolean ctrlDown, WasmTerminalBridge bridge);
